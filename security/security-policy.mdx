...
description: 'Comprehensive security guidelines, risk assessments, and deployment recommendations for Windows-MCP'
icon: 'shield-halved'
---
...
Windows-MCP operates with full system access:
...
<AccordionGroup>
  <Accordion title="Virtual Machines (VMs)" icon="computer">
  ...
  <Accordion title="Sandboxed Environments" icon="box">
  ...
  <Accordion title="Dedicated Test Systems" icon="flask">
...
## Tool-Specific Security Risk Assessment

Based on the tool annotations, here's the security profile of each tool:
...
<Check>Appropriate for Windows-MCP deployment</Check>
...
<Warning>Requires additional security controls</Warning>
...
<Error>DO NOT deploy in these environments</Error>
...
Refer to the [MCP Tools](/concepts/tools-overview) documentation for complete tool annotations.
...
This security policy is part of the Windows-MCP project, licensed under the MIT License.